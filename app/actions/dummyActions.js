...
var setSuccessState = function (response) {
    return {
        ...
        type: actionTypes_ts_1.default.DUMMY_FETCH_SUCCESS,
    };
};
// Error.
var setErrorState = function (error) {
    return {
        ...
        type: actionTypes_ts_1.default.DUMMY_FETCH_FAIL,
    };
};
var setLoadingState = function () {
    return {
        ...
        type: actionTypes_ts_1.default.DUMMY_FETCH_INIT,
    };
};
var fetchDummy = function () {
...
exports.dummyActions = {
    fetchDummy: fetchDummy,
};
